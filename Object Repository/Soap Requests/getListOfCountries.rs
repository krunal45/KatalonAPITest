...
<WebServiceRequestEntity>
   ...
   <name>getListOfCountries</name>
   <tag></tag>
   <elementGuidId>14185ebf-f166-4948-8dde-d869572892f5</elementGuidId>
   ...
   <httpHeaderProperties>
      ...
      <webElementGuid>598b5bc0-7582-4570-9765-138f600b5a26</webElementGuid>
   </httpHeaderProperties>
...
GlobalVariable.=response.ListOfContinentsByNameResponse.ListOfContinentsByNameResult.tContinent[0].sCode


GlobalVariable.=WS.getElementPropertyValue(response,'ListOfContinentsByNameResponse.ListOfContinentsByNameResult.tContinent[0].sCode')
print(CountryISOCode)</verificationScript>
